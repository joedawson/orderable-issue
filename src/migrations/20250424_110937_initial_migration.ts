...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE IF NOT EXISTS "_themes_v" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"parent_id" integer,
  ...
  CREATE INDEX IF NOT EXISTS "themes__status_idx" ON "themes" USING btree ("_status");
  CREATE INDEX IF NOT EXISTS "_themes_v_parent_idx" ON "_themes_v" USING btree ("parent_id");
  CREATE INDEX IF NOT EXISTS "_themes_v_version_version_updated_at_idx" ON "_themes_v" USING btree ("version_updated_at");
  CREATE INDEX IF NOT EXISTS "_themes_v_version_version_created_at_idx" ON "_themes_v" USING btree ("version_created_at");
  CREATE INDEX IF NOT EXISTS "_themes_v_version_version__status_idx" ON "_themes_v" USING btree ("version__status");
  CREATE INDEX IF NOT EXISTS "_themes_v_created_at_idx" ON "_themes_v" USING btree ("created_at");
  CREATE INDEX IF NOT EXISTS "_themes_v_updated_at_idx" ON "_themes_v" USING btree ("updated_at");
  CREATE INDEX IF NOT EXISTS "_themes_v_latest_idx" ON "_themes_v" USING btree ("latest");
